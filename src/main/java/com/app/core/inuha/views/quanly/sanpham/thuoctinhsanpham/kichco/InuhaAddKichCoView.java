 ...
 * @author InuHa
 */
public class InuhaAddKichCoView extends JPanel {
    ...
    /**
     * Creates new form InuhaThemKichCoView
     */
    public InuhaAddKichCoView() {
        initComponents();
    ...
    private void handleClickButtoncancel() {
        ModalDialog.closeModal(InuhaListKichCoView.MODAL_ID_CREATE);
    }
    ...
    private void handleClickButtonSubmit() {
        ...
        if (ten.isEmpty()) { 
            MessageToast.error("Tên kích cỡ không được bỏ trống");
            return;
        }
