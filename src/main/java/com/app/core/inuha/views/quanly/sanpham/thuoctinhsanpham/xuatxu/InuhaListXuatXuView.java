 ...
 * @author InuHa
 */
public class InuhaListXuatXuView extends javax.swing.JPanel {

    private static InuhaListXuatXuView instance;
    ...
    public static InuhaListXuatXuView getInstance() { 
        if (instance == null) { 
            instance = new InuhaListXuatXuView();
        }
        return instance;
    }
    
    /**
     * Creates new form InuhaQuanLyXuatXuView
     */
    public InuhaListXuatXuView() {
        initComponents();
        instance = this;
    ...
    private void setupTable(JTable table) { 
        ...
        ITableActionEvent event = new ITableActionEvent() {
            ...
            public void onEdit(int row) {
                ...
                ModalDialog.showModal(instance, new SimpleModalBorder(new InuhaEditXuatXuView(item), "Chỉnh sửa xuất xứ"), MODAL_ID_EDIT);
            }
    ...
    public void loadDataPage(int page) { 
        try {
            ...
            for(InuhaXuatXuModel m: dataItems) { 
    ...
    private void initComponents() {
        ...
        btnAdd.setText("Thêm xuất xứ mới");
        ...
        tblDanhSach.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "#", "Tên xuất xứ", "Ngày tạo", "Cập nhật cuối", "hành động"
            }
        ) {
    ...
    private void handleClickButtonAdd() {
        ...
        ModalDialog.showModal(this, new SimpleModalBorder(new InuhaAddXuatXuView(), "Thêm xuất xứ mới"), MODAL_ID_CREATE);
    }
}
