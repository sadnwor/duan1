...
public class InuhaEditKichCoView extends JPanel {
    ...
    public InuhaEditKichCoView(InuhaKichCoModel model) {
        this();
        this.model = model;
    ...
    private void handleClickButtonSubmit() {
		...
		InuhaSanPhamView.getInstance().loadDataKichCo();
                ModalDialog.closeModal(InuhaListKichCoView.MODAL_ID_EDIT);
                MessageToast.success("Chỉnh sửa kích cỡ thành công!");
