package com.app.core.inuha.views.quanly.sanpham.thuoctinhsanpham.kichco;
 ...
 * @author InuHa
 */
public class InuhaListKichCoView extends javax.swing.JPanel {

    private static InuhaListKichCoView instance;
    
    private final ExecutorService executorService = Executors.newFixedThreadPool(2);
    
    private final InuhaKichCoService kichCoService = InuhaKichCoService.getInstance();
    ...
    public static InuhaListKichCoView getInstance() { 
        if (instance == null) { 
            instance = new InuhaListKichCoView();
        }
        return instance;
    }
    
    /**
     * Creates new form InuhaQuanLyKichCoView
     */
    public InuhaListKichCoView() {
        initComponents();
        instance = this;
                            ...
                            if (get()) {
                                executorService.submit(() -> {
                                    try {
                                        ...
                                        InuhaAddSanPhamChiTietView.getInstance().loadDataKichCo(true);
    ...
    public void loadDataPage(int page) { 
        try {
            ...
            for(InuhaKichCoModel m: dataItems) { 
    ...
    private void initComponents() {
        ...
        btnAdd.setText("Thêm kích cỡ mới");
        ...
        tblDanhSach.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "#", "Tên kích cỡ", "Ngày tạo", "Cập nhật cuối", "hành động"
            }
        ) {
