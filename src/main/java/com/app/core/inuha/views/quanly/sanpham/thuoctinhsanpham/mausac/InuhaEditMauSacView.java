...
public class InuhaEditMauSacView extends JPanel {
    ...
    public InuhaEditMauSacView(InuhaMauSacModel model) {
        this();
        this.model = model;
