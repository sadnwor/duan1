...
public class InuhaEditChatLieuView extends JPanel {
    ...
    public InuhaEditChatLieuView(InuhaChatLieuModel model) {
        this();
        this.model = model;
