package com.app.core.inuha.views.quanly.sanpham.thuoctinhsanpham.mausac;
 ...
 * @author InuHa
 */
public class InuhaListMauSacView extends javax.swing.JPanel {

    private static InuhaListMauSacView instance;
    
    private final ExecutorService executorService = Executors.newFixedThreadPool(2);
    
    private final InuhaMauSacService mauSacService = InuhaMauSacService.getInstance();
    ...
    public static InuhaListMauSacView getInstance() { 
        if (instance == null) { 
            instance = new InuhaListMauSacView();
        }
        return instance;
    }
    
    /**
     * Creates new form InuhaQuanLyMauSacView
     */
    public InuhaListMauSacView() {
        initComponents();
        instance = this;
    ...
    private void setupTable(JTable table) { 
        ...
        ITableActionEvent event = new ITableActionEvent() {
            ...
            public void onEdit(int row) {
                ...
                ModalDialog.showModal(instance, new SimpleModalBorder(new InuhaEditMauSacView(item), "Chỉnh sửa màu sắc"), MODAL_ID_EDIT);
            }
    ...
    public void loadDataPage(int page) { 
        try {
            ...
            int totalPages = mauSacService.getTotalPage(request);
            if (totalPages < page) { 
                page = totalPages;
            }
            ...
            dataItems = mauSacService.getPage(request);
            
            for(InuhaMauSacModel m: dataItems) { 
    ...
    private void initComponents() {
        ...
        btnAdd.setText("Thêm màu sắc mới");
        ...
        tblDanhSach.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "#", "Tên màu sắc", "Ngày tạo", "Cập nhật cuối", "hành động"
            }
        ) {
    ...
    private void handleClickButtonAdd() {
        ...
        ModalDialog.showModal(this, new SimpleModalBorder(new InuhaAddMauSacView(), "Thêm màu sắc mới"), MODAL_ID_CREATE);
    }
}
