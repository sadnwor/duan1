 ...
 * @author InuHa
 */
public class InuhaAddChatLieuView extends JPanel {
    ...
    /**
     * Creates new form InuhaThemChatLieuView
     */
    public InuhaAddChatLieuView() {
        initComponents();
    ...
    private void handleClickButtoncancel() {
        ModalDialog.closeModal(InuhaListChatLieuView.MODAL_ID_CREATE);
    }
    ...
    private void handleClickButtonSubmit() {
        ...
        if (ten.isEmpty()) { 
            MessageToast.error("Tên chất liệu không được bỏ trống");
            return;
        }
        ...
        executorService.submit(() -> {
            try {
                chatLieuService.insert(model);
                InuhaAddSanPhamView.getInstance().loadDataChatLieu();
                InuhaListChatLieuView.getInstance().loadDataPage(1);
		InuhaSanPhamView.getInstance().loadDataChatLieu();
                ModalDialog.closeModal(InuhaListChatLieuView.MODAL_ID_CREATE);
                MessageToast.success("Thêm mới chất liệu thành công!");
