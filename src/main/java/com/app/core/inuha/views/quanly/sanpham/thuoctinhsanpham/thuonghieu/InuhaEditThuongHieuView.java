...
public class InuhaEditThuongHieuView extends JPanel {
     ...
     */
    public InuhaEditThuongHieuView() {
        initComponents();
    ...
    public InuhaEditThuongHieuView(InuhaThuongHieuModel model) {
        this();
        this.model = model;
    ...
    private void handleClickButtonSubmit() {
        ...
        executorService.submit(() -> {
            try {
                thuongHieuService.update(model);
